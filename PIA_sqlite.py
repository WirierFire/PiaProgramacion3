...
# 1.Base de datos y menú, se hace la conexion donde se guardaran los servicios
try:
    ...
    if conn:
        conn.close()
# 2.Se inicia el menu donde el usuario podra escoger una de las opciones a su gusto
while True:
    LimpiarPantalla()
    print("---SERVICIOS---")
    ...
    print("E: Salir")
# 3. Se  hace la eleecion y partiendo de eso se corre esa parte del codigo
    try:
        ...
        if opcion.upper() == "A":
            ...
            try:
                with sqlite3.connect("servicios.db") as conn: #Puente
                    ...
                    ##Parte final del ticket, donde se muestran los totales del servicio
